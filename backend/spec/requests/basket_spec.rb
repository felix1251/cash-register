...
RSpec.describe BasketController, type: :controller do
  describe "GET /basket" do
    ...
    it "Params Empty" do
      expect { get :calculate }.to raise_error(ActionController::ParameterMissing, /basket/)
      expect { get :calculate, params: {} }.to raise_error(ActionController::ParameterMissing, /basket/)
      expect { get :calculate, params: { basket: "" } }.to raise_error(ActionController::ParameterMissing, /basket/)
    end

    it "Params: GR1,SR1,GR1,GR1,CF1" do
      get :calculate, params: { basket: "GR1,SR1,GR1,GR1,CF1" }, as: :json
    ...
    it "Params: GR1,GR1" do
      get :calculate, params: { basket: "GR1,GR1" }, as: :json
      expect(response).to have_http_status(:ok)
    ...
    it "Params: GR1,CF1,SR1,CF1,CF1" do
      get :calculate, params: { basket: "GR1,CF1,SR1,CF1,CF1" }, as: :json
      expect(response).to have_http_status(:ok)
